...
{
    public class Gun : AbstractAttackItem
    {
        public Gun(int range, string name, double attackRatio, bool lootable, bool removable, Size itemSize, Position itemPositon) 
